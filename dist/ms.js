...
exports.fmLong = exports.fmShort = exports.parse = void 0;
const s = 1000;
const m = 60 * s;
const h = 60 * m;
const d = 24 * h;
...
exports.fmShort = fmShort;
function fmLong(milliseconds) {
    const msAbs = Math.abs(milliseconds);
    let time = '';
    if (msAbs > d) {
